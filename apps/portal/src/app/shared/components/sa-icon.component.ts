...
@Component({
  ...
  template: `
    <div class="icon-wrapper" [class]="variant" [style.--icon-size]="size + 'px'" [style.--icon-bg]="bgColor" [style.--icon-color]="color">
      <iconify-icon [attr.icon]="icon" [attr.width]="iconSize" [attr.height]="iconSize"></iconify-icon>
    </div>
  `,
  styles: [`
    .icon-wrapper {
