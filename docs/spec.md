...
- **v0.2** (2026-04-16): Hoàn tất MVP 5 ngày — 18 tasks (T-001→T-018) merged, 21 PROMPT_LOG entries, ~75 design lessons. Tất cả acceptance criteria pass. Known limitations: xem [`architecture.md` §5](architecture.md).
